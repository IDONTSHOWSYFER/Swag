export default function CTAJoin() {
    return (
        <section className="w-full py-20 text-center bg-gradient-to-r from-[#f20cb5] to-[#ccff33] rounded-xl mx-auto mt-16 mb-16 max-w-6xl shadow-[0_0_40px_rgba(242,12,181,0.4)]">
