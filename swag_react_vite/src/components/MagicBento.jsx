            ...
            <BentoCardGrid gridRef={gridRef}>
                <div className="card-responsive grid gap-2">
                    ...
                    {enableStars ? (
                        ...
                        >
                            ...
                            <div className="card__content flex flex-col relative text-white">
                                ...
                                <p className={`text-xs md:text-sm leading-5 font-geologica opacity-90 ${textAutoHide ? 'text-clamp-2' : ''}`}>
                                    SWAG is a next-gen resell marketplace for sneakers, streetwear and tech.
                                    We blend culture, design and authenticity to turn every drop into an experience.
                                </p>
                            </div>
                        </div>
                    )}
                    ...
                    {enableStars ? (
                        ...
                        >
                            <div className="card__header flex justify-between gap-3 relative text-white">
                                <h3 className="card__label font-righteous text-base opacity-80">Drop preview</h3>
                            </div>
                            <div className="card__content flex flex-col relative text-white h-full">
                                <div className="flex-1 flex items-center justify-center">
                                    {/* MODEL VIEWER PLACEHOLDER */}
                    ...
                    {enableStars ? (
                        ...
                        >
                            ...
                            <div className="card__content flex flex-col gap-4 relative text-white">
                                <div className="grid grid-cols-3 gap-3">
                                    <div>
                                        <p className="text-lg md:text-2xl font-geologica text-pink-400">150K+</p>
                                        <p className="text-[11px] md:text-xs font-geologica opacity-80">
                                            Verified pairs
                                        </p>
                                    </div>
                                    <div>
                                        <p className="text-lg md:text-2xl font-geologica text-pink-400">4.9/5</p>
                                        <p className="text-[11px] md:text-xs font-geologica opacity-80">
                                            Avg seller rating
                                        </p>
                                    </div>
                                    <div>
                                        <p className="text-lg md:text-2xl font-geologica text-pink-400">24/7</p>
                                        <p className="text-[11px] md:text-xs font-geologica opacity-80">
                                            Drop tracking
                                        </p>
                                    </div>
