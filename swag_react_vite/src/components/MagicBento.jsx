...
const DEFAULT_GLOW_COLOR = "242, 12, 181";
    ...
    return (
        <>
          ...
          .bento-section {
            ...
            --border-color: #f20cb574;
            --background-dark: #060010;
            --white: hsl(0, 0%, 100%);
            --purple-primary: rgba(242, 12, 181, 1);
            --purple-glow: rgba(242, 12, 181, 0.2);
            --purple-border: rgba(242, 12, 181, 0.8);
          }
            ...
            <BentoCardGrid gridRef={gridRef}>
                <div className="card-responsive grid grid-cols-2 gap-2">
                    <div className="flex flex-col gap-2">
                        ...
                        >
                            <div className="card__content flex flex-col justify-between relative h-full text-white">
                        ...
                        <ParticleCard
                            className={baseClassName + " items-center justify-center"}
                            style={baseCardStyle}
                            disableAnimations={shouldDisableAnimations}
                            particleCount={particleCount}
                            glowColor={glowColor}
                            ...
                            enableMagnetism={enableMagnetism}
                        >
                            <div className="card__content w-11/12 h-4/5 grid grid-rows-2 grid-cols-2 items-center justify-items-center gap-4 relative text-center text-white">
                                <div className="">
                                    <CountUp className="text-[#f20cb5] text-6xl font-righteous" to={8.4} duration={2} suffix="%" />
                                    <p className="font-geologica text-base" >Conversion Rate</p>
                                </div>
                                <div className="">
                                    <CountUp className="text-[#f20cb5] text-6xl font-righteous" to={146} duration={2} suffix="$" />
                                    <p className="font-geologica text-base" >Average Order Value</p>
                                </div>
                                <div className="">
                                    <CountUp className="text-[#f20cb5] text-6xl font-righteous" to={82} duration={2} suffix="%" />
                                    <p className="font-geologica text-base" >Customer Retention Rate</p>
                                </div>
                                <div className="">
                                    <CountUp className="text-[#f20cb5] text-6xl font-righteous" to={2.3} duration={2} suffix="day" />
                                    <p className="font-geologica text-base" >Time to Sell</p>
                                </div>
                            </div>
                        </ParticleCard>
                    </div>
