export default function Navbar() {
    return (
        <>
            <nav
                className="fixed top-4 left-1/2 -translate-x-1/2 w-[90%] bg-[#0c0c0c6a] backdrop-blur-[20px] shadow-lg rounded-full z-50 px-6 py-3 border-1 border-[#f1f1f126] font-righteous">
                <div className="flex items-center justify-between">
                    <a href="#" className="flex items-center">
                        <svg
                            className="w-10 h-10 transition-transform duration-300 hover:scale-[1.07] hover:brightness-0 hover:saturate-100 hover:saturate-[7500%] hover:brightness-[125%] hover:contrast-[130%] hover:drop-shadow-[0_0_12px_rgba(242,12,181,1)]"
                            viewBox="0 0 258 587"
                            version="1.1"
                        ...
                        >
                            <g transform="matrix(1,0,0,1,-358.569275,-4.239223)">
                                <g transform="matrix(3,0,0,1,0,0)">
                                    <g
                                        transform="matrix(0.333333,0,0,1,107.541717,0.528138)"
                                    >
                        ...
                        <p className="transition text-3xl">SWAG</p>
                    </a>
                    <div className="flex gap-8 opacity-85 items-center">
                        <a href="#" className="hover:text-lime-400 transition">About</a>
                        <a href="#" className="hover:text-lime-400 transition">Marketplace</a>
                        <a href="#" className="hover:text-lime-400 transition">Support</a>
                    </div>
                    <div className="flex gap-4 text-sm items-center">
                        <a href="#" className="px-4 py-2 bg-[#f20cb5] rounded-full hover:scale-105 transition">Log in</a>
                        <a href="#" className="px-4 py-2 bg-lime-400 text-black rounded-full hover:bg-lime-300 hover:scale-105 transition">Register</a>
                    </div>
                </div>
            </nav>
        </>
