      ...
      <div className="max-w-4xl mx-auto mt-16 mb-16 p-10 px-4 rounded-3xl bg-white/5 backdrop-blur-xl border border-white/20 shadow-[0_0_35px_rgba(242,12,181,0.15)]">
        ...
        <div className="mt-12 flex flex-col gap-4 items-center">
          ...
          <div className="flex gap-4 flex-wrap justify-center">
            <a
              href="mailto:support@swag.com?subject=Support%20SWAG&body=Bonjour%20l%27%C3%A9quipe%20SWAG,%0A%0AJe%20vous%20contacte%20%C3%A0%20propos%20de%20..."
              className="px-5 py-3 bg-[#ccff33] text-black font-bold rounded-full shadow-[0_0_20px_#ccff33] hover:bg-[#eaff66] transition"
            >
              Email Support
            </a>
            ...
            <a
              ...
              className="px-5 py-3 bg-white/10 border border-white/20 text-white font-bold rounded-full hover:bg-white/20 transition"
            >
              Join Discord
            </a>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="p-10 rounded-3xl bg-gradient-to-br from-[#0c0c0c] via-[#1a0024] to-[#0c0c0c] border border-[#f20cb533] shadow-[0_0_40px_rgba(242,12,181,0.25)]">
            ...
            <p className="text-white/80 mb-6 text-sm leading-relaxed">
              Account locked? Payment bug?
              Marketplace model not loading?
            ...
            <div className="flex gap-4 flex-wrap">
              ...
              <a
                href="https://wa.me/33612345678?text=Bonjour%20SWAG%20Support%20!"
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-3 bg-lime-400 text-black font-bold rounded-full shadow-[0_0_20px_#ccff33] hover:bg-[#eaff66] transition"
              >
                Call Us
              </a>
            </div>
